                    ...
                    <ul class="space-y-3">
                        @forelse($departement->employes as $employe)
                            <li class="flex justify-between items-center bg-gray-50 dark:bg-gray-700 p-3 rounded shadow-sm border border-gray-100 dark:border-gray-600">
                                <div>
                                    <span class="font-bold text-gray-900 dark:text-white">{{ $employe->user->nom_complet }}</span>
                                    <span class="text-xs text-gray-500 block">{{ $employe->user->email }}</span>
                                </div>
                ...
                <x-card>
                    ...
                    <ul class="space-y-3">
                        @forelse($departement->stagiaires as $stagiaire)
                            <li class="flex justify-between items-center bg-gray-50 dark:bg-gray-700 p-3 rounded shadow-sm border border-gray-100 dark:border-gray-600">
                                <div>
                                    <span class="font-bold text-gray-900 dark:text-white">{{ $stagiaire->user->nom_complet }}</span>
                                    <span class="text-xs text-gray-500 block">{{ $stagiaire->user->email }}</span>
                                </div>
