    ...
    <div x-data="{ loading: false, showPassword: false, showConfirm: false }">
        <div class="text-center mb-6">
            <div class="mx-auto w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center mb-4">
                <svg class="w-7 h-7 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>
            </div>
            <h2 class="text-2xl font-bold text-gray-900">Réinitialiser le mot de passe</h2>
            <p class="text-sm text-gray-500 mt-1">Choisissez un nouveau mot de passe sécurisé.</p>
        </div>
