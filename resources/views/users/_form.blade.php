                    ...
                    <x-card>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="departement_id_employe" name="departement_id" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm" x-bind:required="role === 'Employe_Standard'" x-bind:disabled="role !== 'Employe_Standard'">
                            ...
                            <div>
                                ...
                                <x-text-input id="date_embauche" name="date_embauche" type="date" class="mt-1 block w-full" value="{{ old('date_embauche', isset($user->employe->date_embauche) ? $user->employe->date_embauche->format('Y-m-d') : '') }}" x-bind:required="role === 'Employe_Standard'" x-bind:disabled="role !== 'Employe_Standard'" />
                    ...
                    <x-card>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="date_debut" name="date_debut" type="date" class="mt-1 block w-full" value="{{ old('date_debut', $contratActuel?->date_debut?->format('Y-m-d') ?? '') }}" x-bind:required="role === 'Employe_Standard'" x-bind:disabled="role !== 'Employe_Standard'" />
                                <x-input-error :messages="$errors->get('date_debut')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="date_fin" value="Date de Fin (Optionnelle)" />
                                <x-text-input id="date_fin" name="date_fin" type="date" class="mt-1 block w-full" value="{{ old('date_fin', $contratActuel?->date_fin?->format('Y-m-d') ?? '') }}" x-bind:disabled="role !== 'Employe_Standard'" />
                                <x-input-error :messages="$errors->get('date_fin')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="salaire_base" value="Salaire de Base" />
                                <x-text-input id="salaire_base" name="salaire_base" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('salaire_base', $contratActuel->salaire_base ?? '') }}" x-bind:required="role === 'Employe_Standard'" x-bind:disabled="role !== 'Employe_Standard'" />
                                <x-input-error :messages="$errors->get('salaire_base')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="heures_hebdo" value="Heures Hebdomadaires" />
                                <x-text-input id="heures_hebdo" name="heures_hebdo" type="number" class="mt-1 block w-full" value="{{ old('heures_hebdo', $contratActuel->heures_hebdo ?? '') }}" x-bind:required="role === 'Employe_Standard'" x-bind:disabled="role !== 'Employe_Standard'" />
