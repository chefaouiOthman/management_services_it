...
<aside class="flex flex-col w-64 h-full px-4 py-8 overflow-y-auto bg-white border-r border-gray-200 shadow-sm transition-transform duration-300 ease-in-out z-40 fixed md:relative transform"
    ...
    <div class="flex items-center justify-between mb-8">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
            <span class="text-2xl font-extrabold tracking-tight text-gray-900">MSI</span>
        </a>
    ...
    <div class="flex flex-col justify-between flex-1 mt-2">
        <nav class="space-y-2">
            ...
            <!-- 1. Mon Profil -->
            <a href="{{ route('users.show', auth()->id()) }}" class="flex items-center gap-x-3 px-3 py-2.5 text-sm font-medium transition-colors rounded-xl {{ request()->routeIs('users.show') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('users.show') ? 'text-indigo-700' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                <span>Mon Profil</span>
            </a>

            <!-- 2. Mes Projets (lecture seule) -->
            <a href="{{ route('projets.index') }}" class="flex items-center gap-x-3 px-3 py-2.5 text-sm font-medium transition-colors rounded-xl {{ request()->routeIs('projets.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('projets.*') ? 'text-indigo-700' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
            ...
            <a href="{{ route('factures.index') }}" class="flex items-center gap-x-3 px-3 py-2.5 text-sm font-medium transition-colors rounded-xl {{ request()->routeIs('factures.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('factures.*') ? 'text-indigo-700' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
